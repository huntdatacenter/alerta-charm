...
# Charm variables
CHARM_NAME := alerta
CHARM_STORE_URL := cs:~huntdatacenter/alerta
CHARM_HOMEPAGE := https://github.com/huntdatacenter/alerta-charm/
CHARM_BUGS_URL := https://github.com/huntdatacenter/alerta-charm/issues
